 ...
 *         &lt;element name="differenceData" type="{http://schemas.evosnap.com/CWS/v2.0/Transactions}Manage" minOccurs="0"/>
...
@XmlRootElement(name = "ManageAccountById")
public class ManageAccountById {

    @XmlElement(nillable = true)
    protected String sessionToken;
    @XmlElement(nillable = true)
    protected Manage differenceData;
    @XmlElement(nillable = true)
     ...
     *     
     */
    public Manage getDifferenceData() {
     ...
     *     
     */
    public void setDifferenceData(Manage value) {
