 ...
 *         &lt;element name="differenceData" type="{http://schemas.evosnap.com/CWS/v2.0/Transactions}Adjust" minOccurs="0"/>
...
@XmlRootElement(name = "Adjust")
public class Adjust {

    @XmlElement(nillable = true)
    protected String sessionToken;
    @XmlElement(nillable = true)
    protected com.evosnap.schemas.cws.v2_0.transactions.Adjust differenceData;
    @XmlElement(nillable = true)
     ...
     * @return
     *     possible object is
     *     {@link com.evosnap.schemas.cws.v2_0.transactions.Adjust }
     *     
     */
    public com.evosnap.schemas.cws.v2_0.transactions.Adjust getDifferenceData() {
     ...
     *     
     */
    public void setDifferenceData(com.evosnap.schemas.cws.v2_0.transactions.Adjust value) {
