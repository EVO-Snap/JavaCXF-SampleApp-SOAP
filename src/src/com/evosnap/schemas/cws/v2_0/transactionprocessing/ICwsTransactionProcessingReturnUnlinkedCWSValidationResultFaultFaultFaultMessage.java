...
public class ICwsTransactionProcessingReturnUnlinkedCWSValidationResultFaultFaultFaultMessage extends Exception {
    ...
    public ICwsTransactionProcessingReturnUnlinkedCWSValidationResultFaultFaultFaultMessage(String message, com.evosnap.schemas.cws.v2_0.transactions.faults.CWSValidationResultFault cwsValidationResultFault) {
        super(message);
        this.cwsValidationResultFault = cwsValidationResultFault;
    }

    public ICwsTransactionProcessingReturnUnlinkedCWSValidationResultFaultFaultFaultMessage(String message, com.evosnap.schemas.cws.v2_0.transactions.faults.CWSValidationResultFault cwsValidationResultFault, Throwable cause) {
        super(message, cause);
        this.cwsValidationResultFault = cwsValidationResultFault;
    }
