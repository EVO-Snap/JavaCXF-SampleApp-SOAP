...
public class ICwsTransactionProcessingCaptureSelectiveCWSFaultFaultFaultMessage extends Exception {
    ...
    public ICwsTransactionProcessingCaptureSelectiveCWSFaultFaultFaultMessage(String message, com.evosnap.schemas.cws.v2_0.transactions.faults.CWSFault cwsFault) {
        super(message);
        this.cwsFault = cwsFault;
    }

    public ICwsTransactionProcessingCaptureSelectiveCWSFaultFaultFaultMessage(String message, com.evosnap.schemas.cws.v2_0.transactions.faults.CWSFault cwsFault, Throwable cause) {
        super(message, cause);
        this.cwsFault = cwsFault;
    }
