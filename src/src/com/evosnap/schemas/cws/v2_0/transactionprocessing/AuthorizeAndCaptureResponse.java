 ...
 *       &lt;sequence>
 *         &lt;element name="AuthorizeAndCaptureResult" type="{http://schemas.evosnap.com/CWS/v2.0/Transactions}Response" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AuthorizeAndCaptureResponse {
    ...
    @XmlElement(name = "AuthorizeAndCaptureResult", nillable = true)
    protected Response authorizeAndCaptureResult;
     ...
     *     
     */
    public Response getAuthorizeAndCaptureResult() {
     ...
     *     
     */
    public void setAuthorizeAndCaptureResult(Response value) {
