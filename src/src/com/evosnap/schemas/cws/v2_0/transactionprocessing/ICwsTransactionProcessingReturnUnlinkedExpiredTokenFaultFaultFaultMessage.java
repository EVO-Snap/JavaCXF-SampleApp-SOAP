...
public class ICwsTransactionProcessingReturnUnlinkedExpiredTokenFaultFaultFaultMessage extends Exception {
    ...
    public ICwsTransactionProcessingReturnUnlinkedExpiredTokenFaultFaultFaultMessage(String message, com.evosnap.schemas.identity._1.ExpiredTokenFault expiredTokenFault) {
        super(message);
        this.expiredTokenFault = expiredTokenFault;
    }

    public ICwsTransactionProcessingReturnUnlinkedExpiredTokenFaultFaultFaultMessage(String message, com.evosnap.schemas.identity._1.ExpiredTokenFault expiredTokenFault, Throwable cause) {
        super(message, cause);
        this.expiredTokenFault = expiredTokenFault;
    }
