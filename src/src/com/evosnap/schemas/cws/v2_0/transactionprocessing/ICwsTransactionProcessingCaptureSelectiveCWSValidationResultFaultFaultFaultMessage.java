...
public class ICwsTransactionProcessingCaptureSelectiveCWSValidationResultFaultFaultFaultMessage extends Exception {
    ...
    public ICwsTransactionProcessingCaptureSelectiveCWSValidationResultFaultFaultFaultMessage(String message, com.evosnap.schemas.cws.v2_0.transactions.faults.CWSValidationResultFault cwsValidationResultFault) {
        super(message);
        this.cwsValidationResultFault = cwsValidationResultFault;
    }

    public ICwsTransactionProcessingCaptureSelectiveCWSValidationResultFaultFaultFaultMessage(String message, com.evosnap.schemas.cws.v2_0.transactions.faults.CWSValidationResultFault cwsValidationResultFault, Throwable cause) {
        super(message, cause);
        this.cwsValidationResultFault = cwsValidationResultFault;
    }
