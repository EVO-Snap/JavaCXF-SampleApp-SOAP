...
public class ICwsTransactionProcessingAuthorizeAndCaptureInvalidTokenFaultFaultFaultMessage extends Exception {
    ...
    public ICwsTransactionProcessingAuthorizeAndCaptureInvalidTokenFaultFaultFaultMessage(String message, com.evosnap.schemas.identity._1.InvalidTokenFault invalidTokenFault) {
        super(message);
        this.invalidTokenFault = invalidTokenFault;
    }

    public ICwsTransactionProcessingAuthorizeAndCaptureInvalidTokenFaultFaultFaultMessage(String message, com.evosnap.schemas.identity._1.InvalidTokenFault invalidTokenFault, Throwable cause) {
        super(message, cause);
        this.invalidTokenFault = invalidTokenFault;
    }
