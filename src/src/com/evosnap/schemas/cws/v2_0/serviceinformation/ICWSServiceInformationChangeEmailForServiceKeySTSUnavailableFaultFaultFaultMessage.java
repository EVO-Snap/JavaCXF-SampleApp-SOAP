...
public class ICWSServiceInformationChangeEmailForServiceKeySTSUnavailableFaultFaultFaultMessage extends Exception {
    ...
    public ICWSServiceInformationChangeEmailForServiceKeySTSUnavailableFaultFaultFaultMessage(String message, com.evosnap.schemas.identity._1.STSUnavailableFault stsUnavailableFault) {
        super(message);
        this.stsUnavailableFault = stsUnavailableFault;
    }

    public ICWSServiceInformationChangeEmailForServiceKeySTSUnavailableFaultFaultFaultMessage(String message, com.evosnap.schemas.identity._1.STSUnavailableFault stsUnavailableFault, Throwable cause) {
        super(message, cause);
        this.stsUnavailableFault = stsUnavailableFault;
    }
