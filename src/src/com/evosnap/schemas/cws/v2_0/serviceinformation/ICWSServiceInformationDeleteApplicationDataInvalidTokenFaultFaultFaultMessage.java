...
public class ICWSServiceInformationDeleteApplicationDataInvalidTokenFaultFaultFaultMessage extends Exception {
    ...
    public ICWSServiceInformationDeleteApplicationDataInvalidTokenFaultFaultFaultMessage(String message, com.evosnap.schemas.identity._1.InvalidTokenFault invalidTokenFault) {
        super(message);
        this.invalidTokenFault = invalidTokenFault;
    }

    public ICWSServiceInformationDeleteApplicationDataInvalidTokenFaultFaultFaultMessage(String message, com.evosnap.schemas.identity._1.InvalidTokenFault invalidTokenFault, Throwable cause) {
        super(message, cause);
        this.invalidTokenFault = invalidTokenFault;
    }
