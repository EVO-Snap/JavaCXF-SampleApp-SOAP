...
/**
 * <p>Java class for PhoneResult.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="PhoneResult">
...
public enum PhoneResult {
    ...
    public static PhoneResult fromValue(String v) {
        for (PhoneResult c: PhoneResult.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
