 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;summary xmlns:tns="http://schemas.evosnap.com/CWS/v2.0/Transactions" xmlns:xs="http://www.w3.org/2001/XMLSchema"&gt; Contains information about the customer name. Conditional, required by some Service Providers. If this value is set on the transaction and not required by the Service Provider, the data will not be present on the transaction. &lt;/summary&gt;
 * </pre>
 * 
 * 
...
public class NameInfo {
    ...
    @XmlElement(name = "First", nillable = true)
    protected String first;
    @XmlElement(name = "Middle", nillable = true)
    protected String middle;
    @XmlElement(name = "Last", nillable = true)
