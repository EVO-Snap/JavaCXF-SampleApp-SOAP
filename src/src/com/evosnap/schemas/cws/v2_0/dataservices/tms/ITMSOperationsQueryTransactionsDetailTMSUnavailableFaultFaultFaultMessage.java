...
public class ITMSOperationsQueryTransactionsDetailTMSUnavailableFaultFaultFaultMessage extends Exception {
    ...
    public ITMSOperationsQueryTransactionsDetailTMSUnavailableFaultFaultFaultMessage(String message, com.evosnap.schemas.cws.v2_0.dataservices.tms.faults.TMSUnavailableFault tmsUnavailableFault) {
        super(message);
        this.tmsUnavailableFault = tmsUnavailableFault;
    }

    public ITMSOperationsQueryTransactionsDetailTMSUnavailableFaultFaultFaultMessage(String message, com.evosnap.schemas.cws.v2_0.dataservices.tms.faults.TMSUnavailableFault tmsUnavailableFault, Throwable cause) {
        super(message, cause);
        this.tmsUnavailableFault = tmsUnavailableFault;
    }
